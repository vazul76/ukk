        ...
        <div class="grid auto-rows-min gap-4 md:grid-cols-1">
            <div class="container mx-auto px-4 py-8">
                ...
                <div class="flex justify-between items-center mb-6">
                    <h1 class="text-2xl font-bold text-gray-800">Daftar Industri</h1>
                </div>
                    ...
                    @forelse($industries as $industry)
                        <div class="bg-white rounded-lg shadow-md overflow-hidden border border-gray-200 hover:shadow-lg transition-shadow duration-300">
                            ...
                            <div class="flex items-center p-4 border-b border-gray-200">
                                <div class="flex-shrink-0 h-16 w-16 bg-gray-100 rounded-lg flex items-center justify-center overflow-hidden">
                                    @if($industry->logo)
                                ...
                                <div class="ml-4">
                                    <h3 class="text-lg font-bold text-gray-800">{{ $industry->nama }}</h3>
                                </div>
                            </div>
                            ...
                            <div class="p-4">
                                ...
                                <div class="flex items-start mb-2">
                                    ...
                                    <span class="text-sm text-gray-600">{{ $industry->alamat }}</span>
                                </div>
                                ...
                                <div class="flex items-center mb-4">
                                    ...
                                    <span class="text-sm text-gray-600">{{ $industry->kontak }}</span>
                                </div>
